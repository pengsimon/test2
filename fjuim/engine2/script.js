...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container2").wowSlider({effect:"blinds",prev:"",next:"",duration:25*100,delay:30*100,width:960,height:360,autoPlay:true,playPause:true,stopOnHover:false,loop:true,bullets:true,caption:true,captionEffect:"slide",controls:true,onBeforeStep:0,images:0});