...
<title>FJU Doggy Club 校狗地圖</title>
	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="dc_map.php" accesskey="4" title="">校狗地圖</a></li>
				<?php 
...
<div id="banner-wrapper">
	<div id="banner" class="container">
		...
		<form id="form1" name="form1" method="post" action="./registerServlet">
    		...
    		<p><span class=""></span>會員帳號:<input type="text" name="account"  /></p>
   			<p><span class=""></span>會員密碼:<input type="password" name="pwd"  /></p>
    		<p><span class=""></span>姓名:<input type="text"  name="name" /></p>
    		<p>
      		<span class=""></span>權限:
    		...
    		<input type="radio"  name="level" value="3"/>3
      		...
      		<input type="reset" name="reset" id="reset" value="重填" />
   			...
   			<p><a href="dc_homepage.html">返回首頁</a></p>
		</form>
